	...
	<div class="chat-wrapper">
		...
		<ul class="contact-list">
			...
			<li class="user-row" id='chat_user_1' data-user-id='1'>
				<div class="user-img">
					<a href="#"><img src="/admin/design/data/profile/avatar-1.png" alt=""></a>
				</div>
				<div class="user-info">
					<h4>
			...
			<li class="user-row" id='chat_user_2' data-user-id='2'>
				<div class="user-img">
					<a href="#"><img src="/admin/design/data/profile/avatar-2.png" alt=""></a>
				</div>
				<div class="user-info">
					<h4>
			...
			<li class="user-row" id='chat_user_3' data-user-id='3'>
				<div class="user-img">
					<a href="#"><img src="/admin/design/data/profile/avatar-3.png" alt=""></a>
				</div>
				<div class="user-info">
					<h4>
		...
		<ul class="contact-list">
			...
			<li class="user-row" id='chat_user_4' data-user-id='4'>
				<div class="user-img">
					<a href="#"><img src="/admin/design/data/profile/avatar-4.png" alt=""></a>
				</div>
				<div class="user-info">
					<h4>
			...
			<li class="user-row" id='chat_user_5' data-user-id='5'>
				<div class="user-img">
					<a href="#"><img src="/admin/design/data/profile/avatar-5.png" alt=""></a>
				</div>
				<div class="user-info">
					<h4>
