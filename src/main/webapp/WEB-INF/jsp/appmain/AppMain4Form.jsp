				...
				<div class="content-body">
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							...
							<form name="form1" action="appmain4Save" method="post"
									...
									<div class="col-md-12 col-sm-12 col-xs-12">
										...
										<table id="customers">
											<tr>
												...
												<input value="4" name="appkind" type="hidden" class="form-control">
											...
											<tr>
												...
												<td style="width: 35%" colspan="3"><input name="umemo" type="text"
													class="form-control"></td>
