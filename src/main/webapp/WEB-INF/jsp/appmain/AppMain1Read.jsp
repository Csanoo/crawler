                ...
                padding:15px 0 0 15px;'>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">광고 영상 Update</h1>                            
                            </div>
										...
										<table id="customers">
											...
											<tr>
												...
												<td style="width: 35%"><input name="umemo" type="text"
													value="${appmain1Info.umemo}"
													class="form-control"></td>
													
												<td class="tdl" style="width: 15%">부타이틀</td>

												<td style="width: 35%"><input name="text1" type="text"
													value="${appmain1Info.text1}"
													class="form-control"></td>
											</tr>
