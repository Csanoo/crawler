						...
						<div class="pull-right" style="padding-top: 10px">
							<ul class="list-unstyled">
								<li style="float: left;"><input type="checkbox"
									name="searchType" value="link"
									<c:if test="${fn:indexOf(searchVO.searchType, 'link')!= -1}">checked="checked"</c:if> />
									<label class="chkselect" for="searchType1">YTB 링크</label>&nbsp;&nbsp;

									<input type="checkbox" name="searchType" value="uname"
									<c:if test="${fn:indexOf(searchVO.searchType, 'uname')!=-1}">checked="checked"</c:if> />
									<label class="chkselect" for="searchType2">크리에이터명</label>&nbsp;&nbsp;
								</li>
									...
									<tbody>
										<c:forEach var="listview" items="${listview}"
											...
											<tr>
												...
												<td><a href="/admin/appmain1Read?sn=${listview.sn}">${listview.link}</a></td>
