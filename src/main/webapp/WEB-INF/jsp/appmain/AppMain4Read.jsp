                ...
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">인기크리에이터 Update</h1>                            
                            </div>
									...
									<div class="col-md-12 col-sm-12 col-xs-12">
										...
										<table id="customers">
											<tr>
												...
												<td class="tdl" style="width: 15%">추천 콘텐츠</td>
											...
											<tr>
												...
												<td class="tdl" style="width: 15%">인터뷰</td>
...
<br>
							...
							<script>
								...
								function fn_formDel() {
									document.form1.action="appmain4Delete";
									document.form1.submit();
	...
	<form name="formList" action="AppMain4" method="post">
