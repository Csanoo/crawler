                ...
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Posts Update</h1>                            
                            </div>
		...
		<div class="col-lg-12">
			<section class="box ">
				<header class="panel_header">
					<h2 class="title pull-left">Posts Info</h2>
									...
									<div class="col-md-12 col-sm-12 col-xs-12">
										...
										<table id="customers">
											...
											<tr>
												...
												<td style="width: 85%"><textarea rows=5 name="post" class="form-control">${posts1Info.post}</textarea></td>
											</tr>
...
<c:if test="${posts1Info.imgfile ne ''}">
<div><img src="/images/${posts1Info.imgfile}"></div>
</c:if>
