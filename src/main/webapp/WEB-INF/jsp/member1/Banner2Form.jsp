...
<jsp:include page="/WEB-INF/jsp/common/LeftMenu2.jsp" />
                ...
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Banner Regist</h1>                            
                            </div>
				...
				<div class="content-body">
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							...
							<form name="form1" action="banner2Save" method="post"
									...
									<div class="col-md-12 col-sm-12 col-xs-12">
										...
										<table id="customers">
											...
											<tr>
												...
												<td class="tdl" style="width: 15%">Text1</td>

												<td style="width: 35%"><input name="text1" type="text"
													value="${banner1Info.text1}" class="form-control">
													</td>



												<td class="tdl" style="width: 15%">Text2</td>

												<td style="width: 35%"><input name="text2" type="text"
													value="${banner1Info.text2}" class="form-control"></td>
											</tr>
										</table>
	...
	<form name="formList" action="Banner2List" method="post">
