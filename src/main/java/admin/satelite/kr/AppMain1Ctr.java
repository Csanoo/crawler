...
public class AppMain1Ctr {
	...
	public String appmain1Save(SearchVO searchVO, 
		...
		appmain1Svc.insertAppMain1(appmain1Info, filelist, fileno);
	...
	public String appmain2Delete(HttpServletRequest request, SearchVO searchVO , AppMain1VO appmain1Info, 
			ModelMap modelMap) {
